...
//@interface Campbell_Keddon_Project4Object : NSObject
//@end

@interface Campbell_Keddon_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Campbell_Keddon_Project4Object class]])
		{
			for (NSString *key in [[(Campbell_Keddon_Project4Object*)o modules] allKeys])
			{
