 ...
 * to send analytic data that can be viewed on the Campbell_Keddon_Project4 Dashboard.
 *
 * For information on getting started with Campbell_Keddon_Project4 Platform Services,
