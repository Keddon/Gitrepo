...
@interface Campbell_Keddon_Project4Object : KrollCoverageObject {
#else
@interface Campbell_Keddon_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Campbell_Keddon_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Campbell_Keddon_Project4Object *_campbell_keddon_project4;
    KrollObject* console;
	BOOL shutdown;
