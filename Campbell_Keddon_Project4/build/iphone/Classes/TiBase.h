...
// in simulator we redefine to format for Campbell_Keddon_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.campbell_keddon_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.campbell_keddon_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICampbell_Keddon_Project4NativeItemNone = -1, 
	UICampbell_Keddon_Project4NativeItemSpinner = -2,
	UICampbell_Keddon_Project4NativeItemProgressBar = -3,
	
	UICampbell_Keddon_Project4NativeItemSlider = -4,
	UICampbell_Keddon_Project4NativeItemSwitch = -5,
	UICampbell_Keddon_Project4NativeItemMultiButton = -6,
	UICampbell_Keddon_Project4NativeItemSegmented = -7,
	
	UICampbell_Keddon_Project4NativeItemTextView = -8,
	UICampbell_Keddon_Project4NativeItemTextField = -9,
	UICampbell_Keddon_Project4NativeItemSearchBar = -10,
	
	UICampbell_Keddon_Project4NativeItemPicker = -11,
	UICampbell_Keddon_Project4NativeItemDatePicker = -12,
	
	UICampbell_Keddon_Project4NativeItemInfoLight = -13,
	UICampbell_Keddon_Project4NativeItemInfoDark = -14,
	
	UICampbell_Keddon_Project4NativeItemDisclosure = -15,
	
	UICampbell_Keddon_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Campbell_Keddon_Project4 instances of
