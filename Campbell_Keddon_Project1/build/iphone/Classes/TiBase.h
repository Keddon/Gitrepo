...
// in simulator we redefine to format for Campbell_Keddon_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.campbell_keddon_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.campbell_keddon_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICampbell_Keddon_Project1NativeItemNone = -1, 
	UICampbell_Keddon_Project1NativeItemSpinner = -2,
	UICampbell_Keddon_Project1NativeItemProgressBar = -3,
	
	UICampbell_Keddon_Project1NativeItemSlider = -4,
	UICampbell_Keddon_Project1NativeItemSwitch = -5,
	UICampbell_Keddon_Project1NativeItemMultiButton = -6,
	UICampbell_Keddon_Project1NativeItemSegmented = -7,
	
	UICampbell_Keddon_Project1NativeItemTextView = -8,
	UICampbell_Keddon_Project1NativeItemTextField = -9,
	UICampbell_Keddon_Project1NativeItemSearchBar = -10,
	
	UICampbell_Keddon_Project1NativeItemPicker = -11,
	UICampbell_Keddon_Project1NativeItemDatePicker = -12,
	
	UICampbell_Keddon_Project1NativeItemInfoLight = -13,
	UICampbell_Keddon_Project1NativeItemInfoDark = -14,
	
	UICampbell_Keddon_Project1NativeItemDisclosure = -15,
	
	UICampbell_Keddon_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Campbell_Keddon_Project1 instances of
