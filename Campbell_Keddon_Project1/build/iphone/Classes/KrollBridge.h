...
@interface Campbell_Keddon_Project1Object : KrollCoverageObject {
#else
@interface Campbell_Keddon_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Campbell_Keddon_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Campbell_Keddon_Project1Object *_campbell_keddon_project1;
    KrollObject* console;
	BOOL shutdown;
