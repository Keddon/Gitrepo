...
/**
 The base class for all Campbell_Keddon_Project1 modules
 */
...
/**
 Campbell_Keddon_Project1 Platform calls this method on startup.
 */
-(void)startup;

/**
 Campbell_Keddon_Project1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Campbell_Keddon_Project1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Campbell_Keddon_Project1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Campbell_Keddon_Project1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
