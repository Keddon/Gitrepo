...
//@interface Campbell_Keddon_Project1Object : NSObject
//@end

@interface Campbell_Keddon_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Campbell_Keddon_Project1Object class]])
		{
			for (NSString *key in [[(Campbell_Keddon_Project1Object*)o modules] allKeys])
			{
