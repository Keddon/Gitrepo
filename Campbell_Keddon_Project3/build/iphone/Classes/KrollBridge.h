...
@interface Campbell_Keddon_Project3Object : KrollCoverageObject {
#else
@interface Campbell_Keddon_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Campbell_Keddon_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Campbell_Keddon_Project3Object *_campbell_keddon_project3;
    KrollObject* console;
	BOOL shutdown;
