...
//Rare exceptions to indicate a bug in the _campbell_keddon_project3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Campbell_Keddon_Project3 proxies.
 */
