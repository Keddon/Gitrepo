...
// in simulator we redefine to format for Campbell_Keddon_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.campbell_keddon_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.campbell_keddon_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICampbell_Keddon_Project3NativeItemNone = -1, 
	UICampbell_Keddon_Project3NativeItemSpinner = -2,
	UICampbell_Keddon_Project3NativeItemProgressBar = -3,
	
	UICampbell_Keddon_Project3NativeItemSlider = -4,
	UICampbell_Keddon_Project3NativeItemSwitch = -5,
	UICampbell_Keddon_Project3NativeItemMultiButton = -6,
	UICampbell_Keddon_Project3NativeItemSegmented = -7,
	
	UICampbell_Keddon_Project3NativeItemTextView = -8,
	UICampbell_Keddon_Project3NativeItemTextField = -9,
	UICampbell_Keddon_Project3NativeItemSearchBar = -10,
	
	UICampbell_Keddon_Project3NativeItemPicker = -11,
	UICampbell_Keddon_Project3NativeItemDatePicker = -12,
	
	UICampbell_Keddon_Project3NativeItemInfoLight = -13,
	UICampbell_Keddon_Project3NativeItemInfoDark = -14,
	
	UICampbell_Keddon_Project3NativeItemDisclosure = -15,
	
	UICampbell_Keddon_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Campbell_Keddon_Project3 instances of
