...
//@interface Campbell_Keddon_Project3Object : NSObject
//@end

@interface Campbell_Keddon_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Campbell_Keddon_Project3Object class]])
		{
			for (NSString *key in [[(Campbell_Keddon_Project3Object*)o modules] allKeys])
			{
