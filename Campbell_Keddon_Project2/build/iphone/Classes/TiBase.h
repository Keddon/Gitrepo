...
// in simulator we redefine to format for Campbell_Keddon_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.campbell_keddon_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.campbell_keddon_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICampbell_Keddon_Project2NativeItemNone = -1, 
	UICampbell_Keddon_Project2NativeItemSpinner = -2,
	UICampbell_Keddon_Project2NativeItemProgressBar = -3,
	
	UICampbell_Keddon_Project2NativeItemSlider = -4,
	UICampbell_Keddon_Project2NativeItemSwitch = -5,
	UICampbell_Keddon_Project2NativeItemMultiButton = -6,
	UICampbell_Keddon_Project2NativeItemSegmented = -7,
	
	UICampbell_Keddon_Project2NativeItemTextView = -8,
	UICampbell_Keddon_Project2NativeItemTextField = -9,
	UICampbell_Keddon_Project2NativeItemSearchBar = -10,
	
	UICampbell_Keddon_Project2NativeItemPicker = -11,
	UICampbell_Keddon_Project2NativeItemDatePicker = -12,
	
	UICampbell_Keddon_Project2NativeItemInfoLight = -13,
	UICampbell_Keddon_Project2NativeItemInfoDark = -14,
	
	UICampbell_Keddon_Project2NativeItemDisclosure = -15,
	
	UICampbell_Keddon_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Campbell_Keddon_Project2 instances of
