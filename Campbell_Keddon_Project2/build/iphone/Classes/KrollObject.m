...
//@interface Campbell_Keddon_Project2Object : NSObject
//@end

@interface Campbell_Keddon_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Campbell_Keddon_Project2Object class]])
		{
			for (NSString *key in [[(Campbell_Keddon_Project2Object*)o modules] allKeys])
			{
