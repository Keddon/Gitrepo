...
@interface Campbell_Keddon_Project2Object : KrollCoverageObject {
#else
@interface Campbell_Keddon_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Campbell_Keddon_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Campbell_Keddon_Project2Object *_campbell_keddon_project2;
    KrollObject* console;
	BOOL shutdown;
